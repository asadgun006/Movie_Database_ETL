...
disneyCheckBox = tk.Checkbutton(frame, text="Disney", bg="#ED1D24", fg="#000000", font=("Chiller", 16, 'bold'), variable=disneyCheckBoxVar, onvalue=1, offvalue=0)
disneyCheckBox.place(relx=0.4, y=100, anchor="n")

marvelCheckBoxVar = tk.IntVar()
marvelCheckBox = tk.Checkbutton(frame, text="Marvel", bg="#e6e6e6", fg="#ED1D24", font=("Chiller", 16, 'bold'), variable=marvelCheckBoxVar, onvalue=1, offvalue=0)
marvelCheckBox.place(relx=0.6, y=100, anchor="n")

yearCheckBoxVar = tk.IntVar()
yearCheckBox = tk.Checkbutton(frame, text="By Year", bg="#ED1D24", fg="#000000", font=("Chiller", 15, 'bold'), variable=yearCheckBoxVar, onvalue=1, offvalue=0)
yearCheckBox.place(relx=0.3, y=250, anchor="n")

ratingCheckBoxVar = tk.IntVar()
ratingCheckBox = tk.Checkbutton(frame, text="By IMDb", bg="#e6e6e6", fg="#ED1D24", font=("Chiller", 15, 'bold'), variable=ratingCheckBoxVar, onvalue=1, offvalue=0)
ratingCheckBox.place(relx=0.7, y=250, anchor="n")

hVarOne = tk.DoubleVar()
hVarTwo = tk.DoubleVar()
sliderOne = rs(frame, [hVarOne, hVarTwo], line_s_color="#000000", bgColor="#e6e6e6", min_val=1937, max_val=2022, padX=24, font_size=8, digit_precision='.0f', Height=50)
sliderOne.place(relx=0.28, y=290, anchor="n")

vVarOne = tk.DoubleVar()
vVarTwo = tk.DoubleVar()
sliderTwo = rs(frame, [vVarOne, vVarTwo], line_s_color="#000000", bgColor="#e6e6e6", min_val=0, max_val=10, padX=12, font_size=8, digit_precision='.0f', Height=50,Width=280)
...
def newWindow():
    ...
    textWindow = tk.Text(anotherWindow, yscrollcommand=scrollbarv.set, xscrollcommand=scrollbarh.set, wrap="none", font=("Bahnschrift Light", 14))
